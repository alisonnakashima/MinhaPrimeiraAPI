...
import com.alisonnakashima.minhaprimeiraapi.databinding.ActivityNewItemActitivyBinding
...
class NewItemActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityNewItemActitivyBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityNewItemActitivyBinding.inflate(layoutInflater)
